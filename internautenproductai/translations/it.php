...
$_MODULE['<{internautenproductai}prestashop>internautenproductai_' . md5('Nutze {{product_name}} als Platzhalter für den Artikelnamen.')] = 'Usa {{product_name}} come segnaposto per il nome del prodotto.';
